...
void ui::drawGameOverScreen(Game& game) {
    ...
    constexpr auto titleText{ "Game Over!" };
    ...
    ImGui::PushStyleColor(ImGuiCol_Button, { 0.15f, 0.15f, 0.2f, 1.f });
    ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 0.25f, 0.25f, 0.3f, 1.f });
    ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 0.35f, 0.35f, 0.4f, 1.f });
